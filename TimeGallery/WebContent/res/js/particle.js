window.onload = function(){
    var config = {
        vx: 4, // velocity-x, + right, - left
        vy: 4, // velocity-y
        height: 2, // point height
        width: 2, // point width
        count: 100, // point numbers
        color: "121, 162, 185", // point color
        stroke: "130, 255, 255", // line color
        dist: 6000, // point attach distance
        e_dist: 20000,// mouse attach distance
        max_conn: 10 // max number of connection bettween points
    }
...
var CanvasParticle = (function(){
	...
	function canvasInit(canvasConfig){
		...
		document.getElementById('contain').appendChild(canvas.element);
